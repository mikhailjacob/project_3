...
public class ConditionalTaskDeliver : Action
{
	public ConditionalTaskDeliver()
	{
		actionName = "ConditionalTaskDeliver";
	}
	...
	public override ActionResult Execute(Agent agent, float deltaTime)
	{
        ...
        //Test task.
        if (character.ActiveTask.Type == "deliver") return ActionResult.SUCCESS;
